...
def match_self_mutable_sequence_narrowing_does_not_become_stale(
    value: list[int | str],
) -> None:
    match value:
        case list([int(), str()]):
...
def match_nested_mutable_sequence_narrowing_does_not_become_stale(
...
def match_tuple_expression_or_drops_impossible_structural_alternative(
    a: OrDisplayA,
    b: OrDisplayB1,
) -> None:
    match a, b:
